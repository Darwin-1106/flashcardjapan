...
const database = {
    ...
    // ───────────────────────────────────────────────────────────
    school: [
        { "kanji": "ここ / こちら", "kana": "ここ / こちら", "mean": "Đây, chỗ này / Phía này", "example": "ここは受付です。" },
        { "kanji": "そこ / そちら", "kana": "そこ / そちら", "mean": "Kia, chỗ đó / Phía đó", "example": "そこは会議室です。" },
        { "kanji": "あそこ / あちら", "kana": "あそこ / あちら", "mean": "Đó, chỗ kia / Phía kia", "example": "あそこはトイレです。" },
        { "kanji": "インフォメーション", "kana": "インフォメーション", "mean": "Quầy thông tin", "example": "インフォメーションはどこですか。" },
        { "kanji": "トイレ", "kana": "トイレ", "mean": "Nhà vệ sinh", "example": "トイレへ行きます。" },
        { "kanji": "スーパー", "kana": "スーパー", "mean": "Siêu thị", "example": "スーパーで買います。" },
        { "kanji": "レストラン", "kana": "レストラン", "mean": "Nhà hàng, quán ăn", "example": "あのレストランはおいしいです。" },
        { "kanji": "地下", "kana": "ちか", "mean": "Ngầm, dưới lòng đất", "example": "売り場は地下です。" },
        { "kanji": "携帯電話", "kana": "けいたいでんわ", "mean": "Điện thoại di động", "example": "新しい携帯電話です。" },
        { "kanji": "電子辞書", "kana": "でんしじしょ", "mean": "Kim từ điển", "example": "電子辞書を使います。" },
        { "kanji": "パソコン", "kana": "パソコン", "mean": "Máy tính cá nhân", "example": "パソコンで勉強します。" },
        { "kanji": "消しゴム", "kana": "けしゴム", "mean": "Tẩy", "example": "消しゴムを貸してください。" },
        { "kanji": "本", "kana": "ほん", "mean": "Sách ", "example": "これは日本の本です。" },
        { "kanji": "水", "kana": "みず", "mean": "Nước", "example": "水を飲みます。" },
        { "kanji": "店員", "kana": "てんいん", "mean": "Nhân viên bán hàng", "example": "あの人は店員です。" },
        { "kanji": "いくら", "kana": "いくら", "mean": "Bao nhiêu tiền", "example": "これはいくらですか。" },
        { "kanji": "時計", "kana": "とけい", "mean": "Đồng hồ", "example": "この時計は高いです。" },
    ]
};
