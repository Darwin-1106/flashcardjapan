...
const database = {
    ...
    // ───────────────────────────────────────────────────────────
    school: [
        { kanji: "授業", kana: "じゅぎょう", mean: "Giờ học", example: "授業が始まる。(Giờ học bắt đầu)" },
        { kanji: "教科書", kana: "きょうかしょ", mean: "Sách giáo khoa", example: "教科書を開く。(Mở sách giáo khoa)" },
        { kanji: "黒板", kana: "こくばん", mean: "Bảng đen", example: "黒板に書く。(Viết lên bảng)" },
        { kanji: "宿題", kana: "しゅくだい", mean: "Bài tập về nhà", example: "宿題をする。(Làm bài tập)" },
        { kanji: "試験", kana: "しけん", mean: "Kỳ thi", example: "試験の日。(Ngày thi)" },
        { kanji: "成績", kana: "せいせき", mean: "Điểm số", example: "成績がいい。(Điểm tốt)" },
        { kanji: "卒業", kana: "そつぎょう", mean: "Tốt nghiệp", example: "大学を卒業する。(Tốt nghiệp đại học)" },
        { kanji: "入学", kana: "にゅうがく", mean: "Nhập học", example: "入学式。(Lễ nhập học)" },
        { kanji: "教室", kana: "きょうしつ", mean: "Lớp học", example: "教室に入る。(Vào lớp)" },
        { kanji: "図書館", kana: "としょかん", mean: "Thư viện", example: "図書館で勉強する。(Học ở thư viện)" },
        { kanji: "食堂", kana: "しょくどう", mean: "Nhà ăn", example: "学校の食堂。(Nhà ăn trường)" },
        { kanji: "運動場", kana: "うんどうじょう", mean: "Sân vận động", example: "運動場で遊ぶ。(Chơi ở sân)" },
        { kanji: "部活", kana: "ぶかつ", mean: "Câu lạc bộ", example: "部活に入る。(Tham gia CLB)" },
        { kanji: "友達", kana: "ともだち", mean: "Bạn bè", example: "友達と話す。(Nói chuyện với bạn)" },
        { kanji: "先輩", kana: "せんぱい", mean: "Tiền bối", example: "先輩に挨拶する。(Chào tiền bối)" },
        { kanji: "後輩", kana: "こうはい", mean: "Hậu bối", example: "後輩を教える。(Dạy hậu bối)" },
        { kanji: "制服", kana: "せいふく", mean: "Đồng phục", example: "制服を着る。(Mặc đồng phục)" },
        { kanji: "通学", kana: "つうがく", mean: "Đi học", example: "電車で通学する。(Đi học bằng tàu)" },
        { kanji: "休み時間", kana: "やすみじかん", mean: "Giờ ra chơi", example: "休み時間に遊ぶ。(Chơi giờ ra chơi)" },
        { kanji: "夏休み", kana: "なつやすみ", mean: "Nghỉ hè", example: "夏休みの旅行。(Du lịch nghỉ hè)" },
    ]
};
